...
const ListItem = ({title, Image}: {title: string, Image: string}) =>{
    return(
        <>
                            ...
                            <div className="dz-blog style-1 post-quote bg-white m-b30 blog-half">
                                <div className="dz-info">
                                    <div className="post-quote-icon">
										<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 298.667 298.667" style={{background:"new 0 0 298.667 298.667"}} ><polygon points="0,170.667 64,170.667 21.333,256 85.333,256 128,170.667 128,42.667 0,42.667"/><polygon points="170.667,42.667 170.667,170.667 234.667,170.667 192,256 256,256 298.667,170.667 298.667,42.667"/></svg>
									</div>
