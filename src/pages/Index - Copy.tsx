...
function Index(props) {
  ...
  let layout = 'normal'; /* normal | no_header_footer */

  if (
    pathname === baseName + '/pricing' ||
    pathname === baseName + '/pricing/' ||
    pathname === baseName + '/privacy-policy' ||
    pathname === baseName + '/privacy-policy/'
  ) {
        ...
        <div className="page-wraper">
          <Switch>
            ...
            <Route
              ...
              exact
              component={BooksGridViewSidebar}
            />
            <Route
              path="/books-list-view-sidebar"
              exact
              component={BooksListViewSidebar}
            />
